...
const pane = new Pane(); // creo pannello

const pannello = pane.addFolder ({
  title: 'Parametri sketch', // titolo pannello
});
//pannello.addInput (PARAMS, 'numerocolonne'); // aggiungi questa cosa che ho stabilito prima al pannello
